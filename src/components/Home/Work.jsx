...
const image = [
  { id: 1, image: "/work 1.png", className: "w-[100px] md:w-[150px]" },
  { id: 2, image: "/work 2.png", className: "w-[80px] md:w-[160px]" },
  { id: 3, image: "/work 3.png", className: "w-[160px] md:w-[240px]" },
  { id: 4, image: "/work 4.png", className: "w-[40px] md:w-[70px]" },
  { id: 5, image: "/work 5.png", className: "w-[80px] md:w-[140px]" },
  { id: 6, image: "/work 6.png", className: "w-[80px] md:w-[155px]" },
  { id: 7, image: "/work 7.png", className: "w-[80px] md:w-[135px]" },
  { id: 8, image: "/work 8.png", className: "w-[90px] md:w-[140px]" },
];
...
const Work = () => {
  ...
  return (
    ...
    >
      <div className="overflow-hidden mt-10 sm:mt-14 w-full h-18 sm:h-24 bg-[#0A1E38] flex items-center">
        <div
          ref={scrollRef}
