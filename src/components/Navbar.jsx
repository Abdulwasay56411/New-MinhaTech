...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 left-0 z-50 w-full max-w-350 mx-auto">
      {/* Blue Navbar */}
      ...
      {/* Navbar */}
      <div className="bg-[#09182B] flex w-full items-center justify-between pl-8 pr-20">
        <img className="w-26 h-17" src="/MinhaTech.png" alt="" />
        <div className="hidden md:flex text-[#FFFFFF] gap-5">
          {navbarLink.map((item) => (
            <ul key={item.id} className="group relative py-2">
              <li className="md:text-base lg:text-xl cursor-pointer font-medium">
                {item.name}
              </li>
