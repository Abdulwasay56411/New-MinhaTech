  ...
  return (
    <div className="max-w-350 mx-auto bg-[#12253E] h-auto pt-10 pb-5 md:pb-0">
      <div className="lg:flex justify-between gap-4 px-5">
        <div>
          <img
            className="w-full h-auto lg:w-140 lg:h-70 object-cover"
            src="/Footer.png"
            alt=""
          />
          <div className="flex justify-between py-3">
            <p className="font-montserrat text-sm sm:text-xl text-[#FFFFFF]">
              Stay Connected
            </p>
            <p className="font-montserrat text-sm sm:text-xl text-[#FFFFFF]">
        ...
        {footerText.map((item) => (
          <div className="py-5 lg:py-0" key={item.id}>
            ...
            {[item.text, item.text1, item.text2, item.text3].map(
              (text, idx) => (
                <p
                  className="text-base text-[#FFFFFF] font-montserrat py-2"
                  key={idx}
                >
                  {text}
                </p>
      ...
      <div className="pt-5 pb-2 px-5">
        ...
        <div className="flex flex-wrap justify-between gap-4 py-5">
          <p className="hidden md:block font-montserrat font-medium text-sm text-[#FFFFFFC7]">
            ©2025-2026 Minha Tech. All Rights Reserved
          </p>
          <p className="font-montserrat font-medium text-sm text-[#FFFFFFC7]">
            Terms of Use
          </p>
          <p className="font-montserrat font-medium text-sm text-[#FFFFFFC7]">
            Privacy Policy
